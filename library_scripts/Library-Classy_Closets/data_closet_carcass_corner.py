...
class L_Shelves(fd_types.Assembly):
    ...
    property_id = props_closet.LIBRARY_NAME_SPACE + ".l_shelves"
    ...
    def draw(self):
        ...
        self.add_prompt(name="Add Top KD",prompt_type='CHECKBOX',value=True,tab_index=0,export=True)  
        ...
        Add_Top = self.get_var('Add Top KD','Add_Top')
        ...
        right_back.x_loc('Width-IF(RRS,0,PT)',[Spine_Y_Location,Width,PT,RRS])
        ...
        right_back.y_dim('-Width+IF(RRS,0,PT)',[RRS,Width,PT,Spine_Y_Location])
        ...
        left_back.y_loc('Depth+IF(RLS,0,PT)',[Spine_Y_Location,Depth,PT,RLS])
        ...
        left_back.y_dim('Depth+IF(RLS,0,PT)',[Depth,Spine_Y_Location,RLS,PT])
        ...
        for i in range(1,11):
            ...
            shelf_angled.x_dim('Width-IF(RRS,0,PT)-IF(Add_Backing,IF(Backing_Thickness==0,INCH(0.25),INCH(0.75)),0)',[Width,PT,Add_Backing,Backing_Thickness,RRS])
            shelf_angled.y_dim('Depth+IF(RLS,0,PT)+IF(Add_Backing,IF(Backing_Thickness==0,INCH(0.25),INCH(0.75)),0)',[Depth,PT,Add_Backing,Backing_Thickness,RLS])
            ...
            l_shelf.x_dim('Width-IF(RRS,0,PT)-IF(Add_Backing,IF(Backing_Thickness==0,INCH(0.25),INCH(0.75)),0)',[Width,PT,Add_Backing,Backing_Thickness,RRS])
            l_shelf.y_dim('Depth+IF(RLS,0,PT)+IF(Add_Backing,IF(Backing_Thickness==0,INCH(0.25),INCH(0.75)),0)',[Depth,PT,Add_Backing,Backing_Thickness,RLS])
...
class Corner_Shelves(fd_types.Assembly):
...
class PROMPTS_L_Shelves(fd_types.Prompts_Interface):
    bl_idname = props_closet.LIBRARY_NAME_SPACE + ".l_shelves"
